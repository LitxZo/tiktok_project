...
type Comment struct {
	...
	User       *core.User `protobuf:"bytes,2,req,name=user" json:"user,omitempty"`                               // 评论用户信息
...
var file_comment_action_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x72, 0x61, 0x2e, 0x66, 0x69, 0x72, 0x73, 0x74, 0x1a, 0x0a, 0x75, 0x73, 0x65, 0x72,
	...
	0x61, 0x74, 0x65, 0x42, 0x1b, 0x5a, 0x19, 0x2e, 0x2f, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x66,
	0x69, 0x72, 0x73, 0x74, 0x3b, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x66, 0x69, 0x72, 0x73, 0x74,
}
...
var file_comment_action_proto_goTypes = []interface{}{
	...
	(*core.User)(nil),                   // 3: douyin.core.User
}

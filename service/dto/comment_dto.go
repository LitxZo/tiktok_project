...
type CommentActionRequest struct {
	Token       string `protobuf:"bytes,1,req,name=token" json:"token,omitempty" binding:"required"`                              // 用户鉴权token
	VideoId     string `protobuf:"varint,2,req,name=video_id,json=videoId" json:"video_id,omitempty" binding:"required"`          // 视频id
	ActionType  string `protobuf:"varint,3,req,name=action_type,json=actionType" json:"action_type,omitempty" binding:"required"` // 1-发布评论，2-删除评论
	CommentText string `protobuf:"varint,4,req,name=comment_text,json=commentText" json:"comment_text,omitempty" `                // 用户填写的评论内容，在action_type=1的时候使用
	CommentId   string `protobuf:"varint,5,req,name=comment_id,json=commentId" json:"comment_id,omitempty" `                      //要删除的评论id，在action_type=2的时候使用
	UserId      string `protobuf:"varint,6,req,name=user_id,json=userId" json:"user_id,omitempty" binding:"required"`             // 用户id
}

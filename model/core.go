...
type User struct {
	...
	FollowId        FollowId `protobuf:"bytes,13,opt,name=follow_id" jsopn:"follow_id,omitempty"`                                               //关注者id
}
...
func (f *FollowId) Scan(value interface{}) error {
	v, _ := value.([]byte)
	return json.Unmarshal(v, f)
}

func (f FollowId) Value() (driver.Value, error) {
